...
namespace kXlUtils
{
    ...
    bool getVector(LPXLOPER12 in, kVector<int>& out);
    bool getRowVector(LPXLOPER12 in, kVector<double>& out);
    bool getRowVector(LPXLOPER12 in, kVector<int>& out);
...
bool kXlUtils::getVector(LPXLOPER12 in, kVector<int>& out)
{
    size_t m = getRows(in);
...
bool kXlUtils::getRowVector(LPXLOPER12 in, kVector<double>& out)
{
    size_t m = getCols(in);
...
bool kXlUtils::getRowVector(LPXLOPER12 in, kVector<int>& out)
{
    size_t m = getCols(in);
